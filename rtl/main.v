...
`include "builddate.v"
	...
	// Wishbone slave definitions for bus wb(SIO), slave systimer
	wire		systimer_sel, systimer_stall, systimer_ack;
	wire	[31:0]	systimer_data;
	...
	wire		cpu_delay_sel, cpu_delay_stall, cpu_delay_ack, cpu_delay_err;
	...
	wire		wbu_delay_sel, wbu_delay_stall, wbu_delay_ack, wbu_delay_err;
...
`ifdef	INCLUDE_CPU
	...
	wbpriarbiter #(32,23)	bus_arbiter(i_clk,
		...
		cpu_cyc, (cpu_stb)&&(cpu_delay_sel), cpu_we, cpu_addr, cpu_data, cpu_sel,
			cpu_delay_stall, cpu_delay_ack, cpu_delay_err,
		...
		(wbu_cyc),
			...
			wbu_addr[(23-1):0],
			wbu_data, wbu_sel,
			wbu_delay_stall, wbu_delay_ack, wbu_delay_err,
		// Common bus returns
...
`ifdef	BUS_DELAY_NEEDED
	busdelay #(23)	wbu_delayi_delay(i_clk, i_reset,
		wbu_delayi_cyc, wbu_delayi_stb, wbu_delayi_we, wbu_delayi_addr, wbu_delayi_odata, wbu_delayi_sel,
			wbu_delayi_stall, wbu_delayi_ack, wbu_delayi_idata, wbu_delayi_err,
