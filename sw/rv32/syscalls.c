////////////////////////////////////////////////////////////////////////////////
//
// Filename:	rv32/syscalls.c
//
// Project:	ZipVersa, Versa Brd implementation using ZipCPU infrastructure
//
// Purpose:	Implements the platform specific system calls required by
//		an implementation of the newlib library, for our rv32 software.
//
//
...
#endif
#ifdef	GPIO_SIMHALT
	// Tell Verilator to halt the simulation.  This register goes nowhere
	// if we aren't in a simulation
	*_gpio = GPIO_SIMHALT;
#endif
	// _hw_shutdown(rcode);
	for(;;)
